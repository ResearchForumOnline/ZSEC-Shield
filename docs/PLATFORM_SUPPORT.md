...
ZSEC Antivirus Community 0.3.31 means a Windows graphical protection control plane
...
| --- | --- | --- |
| Current Windows desktop source | `0.3.31` | Defender-backed Windows control plane, bounded local scanning, self-restarting post-change monitoring, encrypted quarantine, signed data-only feeds, and browser controls described below |
