...
| Current development branch | `0.3.5` Community | 0.3.4 feature set plus observer-timestamped debounce, stricter Windows GUI evidence, bounded event-priority scanning during the first inventory and fail-closed companion presentation; ZSEC Browser remains independently versioned |
...
| Artifact family | Architecture | Delivery | Automatic companion | Key protection in 0.3.5 Community code | Publisher identity | Status |
| --- | --- | --- | --- | --- | --- | --- |
