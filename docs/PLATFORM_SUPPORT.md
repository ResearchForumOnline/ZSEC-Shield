...
| Current development branch | `0.3.2` unreleased candidate | 0.3 feature set plus multi-root Windows monitoring, baseline progress heartbeats, the path-free bounded exact-rule content worker and broker digest verification; ZSEC Browser remains independently versioned |
...
| Artifact family | Architecture | Delivery | Automatic companion | Key protection in 0.3.2 development code | Publisher identity | Status |
| --- | --- | --- | --- | --- | --- | --- |
