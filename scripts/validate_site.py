...
DOWNLOAD_PAGES: dict[str, DownloadPolicy] = {
    "zero-security/download": {
        ...
        "artifacts": {
            ...
            "/downloads/zero-security/zsec-antivirus-desktop-0.3.3-windows-x86_64.zip",
    ...
    "zero-browser/download": {
        ...
        "fingerprints": 2,
        "artifacts": {
            "/downloads/zero-browser/zsec-browser-community-0.3.4-windows-x64-unsigned.zip",
            "/downloads/zero-browser/zsec-browser-shields-0.5.0-chromium-mv3.zip",
        },
    },
}
