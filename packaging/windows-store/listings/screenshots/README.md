...
python packaging/windows-store/validate_screenshots.py create `
  ...
  --package packaging/windows-store/out/ZSEC-Antivirus-0.3.30.0-x64.msix `
  --executable "packaging/windows-store/out/antivirus-0.3.30.0-layout/App/ZSEC Antivirus.exe" `
